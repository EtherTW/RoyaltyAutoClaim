...
export interface RoyaltyAutoClaimInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "reviewSubmission4337",
...
export interface RoyaltyAutoClaim extends BaseContract {
  ...
  reviewSubmission4337: TypedContractMethod<
  ...
  ): TypedContractMethod<[emailNullifier: BytesLike], [boolean], "view">;
  getFunction(
  ...
  >;
  getFunction(
    nameOrSignature: "reviewSubmission4337"
  ): TypedContractMethod<
    [title: string, royaltyLevel: BigNumberish, nullifier: BigNumberish],
    [void],
    "nonpayable"
