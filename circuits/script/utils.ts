...
/**
 * Parse raw email to extract title, recipient, and nullifier
 * @param email - raw email content (Buffer or string)
 * @returns - object with title (extracted from subject after colon), recipient address, and nullifier (Pedersen hash of DKIM signature)
 */
